...
/**
 * Desc: Product PB客户端初始化
 * Date: 2019/9/23
 *
 * @author duanzhengqiang
 */
public class ProductProtobufClientInitializer extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel ch) throws Exception {
        ...
        //custom
        pipeline.addLast(new ProductProtobufClientHandler());
    }
}
